...
\only{\inputminted[highlightlines={4,5,7-9,12}]{\coroCpp}{code-examples/async-raii/manual_noraii.cpp}}<1>
\only{\inputminted[highlightlines={5}]{\coroCpp}{code-examples/async-raii/manual_noraii.cpp}}<2>
\only{\inputminted[highlightlines={7-9}]{\coroCpp}{code-examples/async-raii/manual_noraii.cpp}}<3>
\only{\inputminted[highlightlines={4}]{\coroCpp}{code-examples/async-raii/manual_noraii.cpp}}<4>
\only{\inputminted[highlightlines={12}]{\coroCpp}{code-examples/async-raii/manual_noraii.cpp}}<5>
\end{frame}

\begin{frame}{Proposed coroutines improvement}
\begin{itemize}
	\item make co\_await create it's own scope.
